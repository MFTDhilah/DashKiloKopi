...
class FillPermissionsForKuisioner extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForKuisioner constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.kuisioner',
            'admin.kuisioner.index',
            'admin.kuisioner.create',
            'admin.kuisioner.show',
            'admin.kuisioner.edit',
            'admin.kuisioner.delete',
            'admin.kuisioner.bulk-delete',
        ]);
