...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('manipulations'), 'has-success': fields.manipulations && fields.manipulations.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
            <textarea class="form-control" v-model="form.manipulations" v-validate="'required'" id="manipulations" name="manipulations"></textarea>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('custom_properties'), 'has-success': fields.custom_properties && fields.custom_properties.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
            <textarea class="form-control" v-model="form.custom_properties" v-validate="'required'" id="custom_properties" name="custom_properties"></textarea>
        </div>
        <div v-if="errors.has('custom_properties')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('custom_properties') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('generated_conversions'), 'has-success': fields.generated_conversions && fields.generated_conversions.valid }">
    <label for="generated_conversions" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.medium.columns.generated_conversions') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
            <textarea class="form-control" v-model="form.generated_conversions" v-validate="'required'" id="generated_conversions" name="generated_conversions"></textarea>
        </div>
        <div v-if="errors.has('generated_conversions')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('generated_conversions') }}</div>
    </div>
</div>
