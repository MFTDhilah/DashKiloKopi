...
class MediaController extends Controller
{
    ...
    public function index(IndexMedium $request)
    {
        ...
        $data = AdminListing::create(Medium::class)->processRequestAndGet(
            ...
            ['id', 'model_type', 'model_id', 'uuid', 'collection_name', 'name', 'file_name', 'mime_type', 'disk', 'conversions_disk', 'size', 'order_column'],

            // set columns to searchIn
            ['id', 'model_type', 'uuid', 'collection_name', 'name', 'file_name', 'mime_type', 'disk', 'conversions_disk', 'manipulations', 'custom_properties', 'generated_conversions', 'responsive_images']
        );
